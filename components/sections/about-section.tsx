      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Despre Electrovladescu
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
            Cristi Vlădescu este electrician profesionist specializat în instalații electrice pentru locuințe și spații comerciale. Cu atenție la detalii și respectarea standardelor de siguranță, Electrovladescu oferă soluții moderne și eficiente pentru orice proiect electric.
          </p>
        </motion.div>
